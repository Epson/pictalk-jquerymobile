(function(){
  ...
  Viewer = {
    ...
    showFriendList: function(friendListArray){
      ...
      for (i$ = 0; i$ < length; ++i$) {
        i = i$;
        li = $("<li class='contact-info'>" + "<a href='javascript:void(0);'>" + "<img src='images/1.jpeg'/>" + "<span class='contact-name'>" + friendListArray[i].username + "</span> <br/> <br />" + "<span class='contact-email'>" + friendListArray[i].userId + "</span>" + "</a></li>");
